...
// "not found" means the trio answered end-to-end, while a 502 whose `cause` is
// *-unreachable means a link in the trio is down. Read `cause` first — the
// servers no longer relay upstream text; `error` is the fallback for a server
// that predates the token.
{
